...
def test_net(sess, net, imdb, weights_filename, max_per_image=100, thresh=0.05):
    ...
    # CSI 4106: added some code to calculate the average detection time
    sum_detection_time = 0
    ...
    for i in range(num_images):
        ...
        # CSI 4106: add the detection time of all test images together
        sum_detection_time += _t['im_detect'].average_time

    det_file = os.path.join(output_dir, 'detections.pkl')
    with open(det_file, 'wb') as f:
        pickle.dump(all_boxes, f, pickle.HIGHEST_PROTOCOL)

    # CSI 4106: calculate and print the average detection time
    print('\n\n\n=================================================================\n\n')
    print('The average detection time over', num_images, 'images is', sum_detection_time / num_images,'\n\n')
