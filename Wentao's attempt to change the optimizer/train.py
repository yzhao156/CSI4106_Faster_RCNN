...
class Train:
    ...
    def train(self):
        ...
        with sess.graph.as_default():
            ...
            # CSI 4106: changed the optimizer to AdamOptimizer
            lr = tf.Variable(cfg.FLAGS.learning_rate, trainable=False)
            # momentum = cfg.FLAGS.momentum
            # optimizer = tf.train.MomentumOptimizer(lr, momentum)

            optimizer = tf.train.AdamOptimizer(learning_rate = cfg.FLAGS.learning_rate)
            ...
            valwriter = tf.summary.FileWriter('val_log')
